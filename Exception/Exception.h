...
public:
  Semantic_Error_Twise_Declare(int n, const String &str)
      : Semantic_Error(n), name(str) {}
  virtual String what() const throw() {
...
public:
  Semantic_Error_Not_Declare(int n, const String &str)
      : Semantic_Error(n), name(str) {}
  virtual String what() const throw() {
    String tmp("Semantic_Error: ");
    tmp += String("in str: ");
...
public:
  Semantic_Error_Loop(int n, const String &str)
      : Semantic_Error(n), word(str) {}
  virtual String what() const throw() {
    String tmp("Semantic_Error: ");
    tmp += String("in str: ");
    tmp += String::int_to_str(get_n_str());
